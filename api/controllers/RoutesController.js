...
module.exports = {
  ...
  find: function (req, res) {
    ...
    const getRoutes = async () => {
      ...
      if (Routes_count < 1) {
        throw new CustomError('Route not found', {
          status: 403
        });
      }
  ...
  findOne: function (req, res) {
    ...
    const getRoutes = async () => {
      ...
      if (routes)
        ...
        throw new CustomError('Routes not found', {
          status: 403
        });
  ...
  update: function (req, res) {
    ...
    const updateRoutes = async () => {
      ...
      if (oldRoutes < 1) {
        throw new CustomError('Invalid Routes  Id', {
          status: 403
        });
      }
  ...
  delete: function (req, res) {
    ...
    const deleteRoutes = async () => {
      ...
      if (checkRoutes < 1) {
        throw new CustomError('Invalid Route Id', {
          status: 403
        });
      }
