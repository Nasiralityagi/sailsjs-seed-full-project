...
module.exports = {
    ...
    find: function (req, res) {
      ...
      const getDealerPackages = async() => {
        ...
        const DealerPackages_count = await DealerPackages.count({ where: {  dealer: req.param('dealer_id') }});
        if (!DealerPackages_count){
          return new CustomError('DealerPackages not found', {
            status: 403
          });
        }
    ...
    update: function (req, res) {
      ...
      const updateDealerPackages = async() => {
        ...
        if (oldDealerPackages < 1) {
          return new CustomError('Invalid DealerPackages  Id', {
            status: 403
          });
        }
