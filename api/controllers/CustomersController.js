...
module.exports = {
    ...
    login: async function (req, res) {
      ...
      var customersRecord = await Customers.findOne({
      ...
      const process = async()=>{
          var fnResult = await bbService.checkPassword(req.body.password, customersRecord.password);
          if(!fnResult)
          {
             return {error: 'error'};
          }
    ...
    delete: function (req, res) {
      ...
      const deleteCustomer = async() => {
        ...
        const checkCustomer = await Customers.count({
          id: customerId
        });
